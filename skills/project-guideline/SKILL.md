...
- **Validation Gates**: Both GitHub Actions and GitLab CI run explicit `bun run lint`, `bun run test`, `bun run typecheck`, and `bun run tsc` jobs before build/release steps proceed.
